...
export async function getServerSideProps({params}){
  const {enlace} = params; // distructuring al prop de enlacd generado por next
...
console.log(tienePassword);
 ...
 const verificarPassword = async e =>{
   ...
   console.log(resultado);
      ...
      alert('pasword incorrecto, intenta con otro man..!!!')
   }
       ...
       { tienePassword ? (
         ...
         <div className="flex justify-center mt-5"> 
            <div className= "w-full max-w-lg"> 
                      ...
                      <div className="mb-4">
                                   <label className="block text-black text-sm font-bold mb-2" htmlFor="password">Nombre</label>
                                <input 
                                    type="password"
